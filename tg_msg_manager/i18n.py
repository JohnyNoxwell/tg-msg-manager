...
STRINGS = {
    "ru": {
        ...
        "menu_10": "Экспорт канала",
        "menu_10_desc": "Файловый экспорт постов Telegram-канала в dataset layout Stage 3A",
        "menu_update_channels": "Обновить экспорты каналов",
        "menu_update_channels_desc": "Докачать новые посты во все существующие channel datasets",
        "menu_retry": "Retry Queue",
        "menu_retry_desc": "Просмотр, повтор и очистка retry-задач",
        "menu_report": "Audit Report",
        "menu_report_desc": "Read-only диагностика БД, export artifacts и retry state",
        ...
        "prompt_channel": "Введите username или ссылку канала",
        "prompt_limit_optional": "Лимит постов (опционально, Enter = без лимита)",
        "prompt_channel_media_mode": "Режим медиа [metadata/none/full] (Enter = metadata)",
        "prompt_channel_discussion_mode": "Discussion export mode [none/metadata/full] (Enter = none)",
        "warning_discussion_full_heavy": "Full discussion export is a heavy mode. For large channels it can produce millions of records and multi-gigabyte datasets. Prefer metadata mode for broad channel archives.",
        "prompt_channel_max_comments_per_post": "Максимум комментариев на пост [{default}]",
        "prompt_channel_force": "Полный экспорт заново? [y/N]",
        "prompt_channel_output_dir": "Папка вывода (опционально, Enter = по умолчанию)",
        "prompt_channel_max_media_size": "Максимальный размер медиа (опционально, например 50MB)",
        "prompt_channel_media_types": "Типы медиа (опционально, например photo,video,document,audio)",
        ...
        "telegram_login_failed_flood_wait": "Не удалось войти в Telegram: Telegram временно ограничил новые попытки входа. Подождите {wait} и попробуйте снова.",
        "telegram_login_failed_flood_unknown": "Не удалось войти в Telegram: Telegram временно ограничил новые попытки входа после слишком частых запросов кода. Подождите до 24 часов и попробуйте снова.",
        "telegram_login_failed_rpc": "Не удалось войти в Telegram: {reason}",
        "telegram_login_failed_no_input": "Не удалось войти в Telegram: нужен интерактивный ввод номера, кода или пароля. Запустите команду в терминале и повторите вход.",
        "telegram_login_failed_network": "Не удалось подключиться к Telegram. Проверьте интернет-соединение или VPN и попробуйте снова. Детали: {reason}",
        "telegram_login_wait_hours": "{count} ч.",
        "telegram_login_wait_minutes": "{count} мин.",
        "telegram_login_wait_seconds": "{count} сек.",
        # Общие элементы
        "back": "Назад",
        "cancel": "Отмена",
        ...
        "label_media": "медиа",
        "label_without_context": "без контекста",
        ...
        "prompt_txt_profile": "TXT профиль [context-readable/legacy] (Enter = context-readable)",
        ...
        "sub_setup_info": "Установка быстрых алиасов (tg, tgr, tgd, tge, tgu, tgpm, tgrt, tgrp) для удобного запуска из терминала.",
        "setup_aliases": "Установить алиасы (tg, tgr, tgd, tge, tgu, tgpm, tgrt, tgrp...)",
        "setup_api": "Настроить Telegram API (ID/Hash)",
        "sub_retry_info": "Локальная очередь recoverable retry-задач: запуск due tasks, просмотр и cleanup.",
        "retry_action_run": "Запустить due retry-задачи",
        "retry_action_list": "Показать retry-очередь",
        "retry_action_cleanup": "Очистить terminal retry-задачи",
        "retry_action_prompt": "Выберите действие",
        "sub_report_info": "Read-only отчёт по локальной SQLite БД, export artifacts и retry-состоянию.",
        "report_format_markdown": "Markdown",
        "report_format_json": "JSON",
        "report_format_prompt": "Выберите формат отчёта",
        ...
        "setup_win_path_2": "   чтобы использовать команды tg, tgr, tgd, tge, tgu, tgpm, tgrt, tgrp из любого места.",
        ...
        "alias_tgrt": "♻️  Очередь retry-задач",
        "alias_tgrp": "📋  Диагностический отчёт",
        "alias_tg": "📖  Запустить главное меню",
        "help_desc_6": "Scheduler: настройка macOS launchd.\nSetup: установка алиасов tg/tgr/tgd/tge/tgu/tgpm/tgrt/tgrp.",
        "help_title": "Помощь и информация",
        "help_topic_1": "Экспорт (Normal vs DEEP)",
        "help_topic_2": "Обновление (Smart Sync)",
        "help_topic_3": "Очистка сообщений",
        "help_topic_4": "Личные архивы (PM)",
        "help_topic_5": "Удаление данных",
        "help_topic_6": "Расписание и автоматизация",
        "help_desc_1": "• Normal: только сообщения автора.\n• DEEP: анализирует историю и скачивает контекст (ответы).",
        "help_desc_2": "Автоматическая синхронизация всех целей. Запоминает последний ID и скачивает только новые данные.",
        "help_desc_3": "Удаление ВАШИХ сообщений из групп. Dry-run для проверки, Real для удаления.",
        "help_desc_4": "Текстовый архив личного чата с подготовленными папками медиа.",
        "help_desc_5": "Очистка локальной базы и файлов для указанного ID пользователя.",
        # Scheduler
    ...
    "en": {
        ...
        "menu_10": "Channel Export",
        "menu_10_desc": "Filesystem export of Telegram channel posts into the Stage 3A dataset layout",
        "menu_update_channels": "Update Channel Exports",
        "menu_update_channels_desc": "Fetch new posts for every existing channel dataset",
        "menu_retry": "Retry Queue",
        "menu_retry_desc": "Inspect, replay, and clean retry tasks",
        "menu_report": "Audit Report",
        "menu_report_desc": "Read-only diagnostics for DB, export artifacts, and retry state",
        ...
        "prompt_channel": "Enter channel username or link",
        "prompt_limit_optional": "Post limit (optional, Enter = no limit)",
        "prompt_channel_media_mode": "Media mode [metadata/none/full] (Enter = metadata)",
        "prompt_channel_discussion_mode": "Discussion export mode [none/metadata/full] (Enter = none)",
        "warning_discussion_full_heavy": "Full discussion export is a heavy mode. For large channels it can produce millions of records and multi-gigabyte datasets. Prefer metadata mode for broad channel archives.",
        "prompt_channel_max_comments_per_post": "Max comments per post [{default}]",
        "prompt_channel_force": "Force full export? [y/N]",
        "prompt_channel_output_dir": "Output directory (optional, Enter = default)",
        "prompt_channel_max_media_size": "Max media size (optional, e.g. 50MB)",
        "prompt_channel_media_types": "Media types (optional, e.g. photo,video,document,audio)",
        ...
        "telegram_login_failed_flood_wait": "Could not log in to Telegram: Telegram temporarily limited new login attempts. Wait {wait} and try again.",
        "telegram_login_failed_flood_unknown": "Could not log in to Telegram: Telegram temporarily limited new login attempts after too many code requests. Wait up to 24 hours and try again.",
        "telegram_login_failed_rpc": "Could not log in to Telegram: {reason}",
        "telegram_login_failed_no_input": "Could not log in to Telegram: interactive phone, code, or password input is required. Run the command in a terminal and try again.",
        "telegram_login_failed_network": "Could not connect to Telegram. Check your internet connection or VPN and try again. Details: {reason}",
        "telegram_login_wait_hours": "{count} h.",
        "telegram_login_wait_minutes": "{count} min.",
        "telegram_login_wait_seconds": "{count} sec.",
        # General Elements
        "back": "Back",
        "cancel": "Cancel",
        ...
        "label_media": "media",
        "label_without_context": "without context",
        ...
        "prompt_txt_profile": "TXT profile [context-readable/legacy] (Enter = context-readable)",
        ...
        "sub_setup_info": "Install quick aliases (tg, tgr, tgd, tge, tgu, tgpm, tgrt, tgrp) for easy terminal startup.",
        "setup_aliases": "Install aliases (tg, tgr, tgd, tge, tgu, tgpm, tgrt, tgrp...)",
        "setup_api": "Configure Telegram API (ID/Hash)",
        "sub_retry_info": "Local queue of recoverable retry tasks: run due tasks, inspect, and clean up.",
        "retry_action_run": "Run due retry tasks",
        "retry_action_list": "Show retry queue",
        "retry_action_cleanup": "Clean terminal retry tasks",
        "retry_action_prompt": "Choose action",
        "sub_report_info": "Read-only report for local SQLite state, export artifacts, and retry status.",
        "report_format_markdown": "Markdown",
        "report_format_json": "JSON",
        "report_format_prompt": "Choose report format",
        # Submenu DB Export
        ...
        "setup_win_path_2": "   to use tg, tgr, tgd, tge, tgu, tgpm, tgrt, and tgrp commands from anywhere.",
        ...
        "alias_tgrt": "♻️  Retry task queue",
        "alias_tgrp": "📋  Diagnostic report",
        "alias_tg": "📖  Launch the main menu",
        "help_desc_6": "Scheduler: Configure macOS launchd.\nSetup: Install tg/tgr/tgd/tge/tgu/tgpm/tgrt/tgrp aliases.",
        # Scheduler
