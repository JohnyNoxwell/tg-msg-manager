...
- источником истины считаются текущий код, `TODO.md`, существующие тесты и актуальные runtime contracts;
- уже выполненные задачи из `TODO.md` не должны заново попадать в execution scope;
